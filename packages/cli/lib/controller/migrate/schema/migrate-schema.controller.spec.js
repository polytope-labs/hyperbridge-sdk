...
const migrate_schema_controller_1 = require("./migrate-schema.controller");
describe('Subgraph Graphql Schema migration', () => {
    ...
    `;
        const migratedSchema = (0, migrate_schema_controller_1.migrateSchemaFromString)(schema);
        console.log('Migrated schema', migratedSchema);
        expect(migratedSchema).toMatchSnapshot();
    });
});
//# sourceMappingURL=migrate-schema.controller.spec.js.map