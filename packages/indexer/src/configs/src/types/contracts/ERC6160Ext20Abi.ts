...
export interface ERC6160Ext20AbiInterface extends utils.Interface {
  functions: {
    ...
    "getBurnerRole()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getBurnerRole",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ERC6160Ext20Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC6160Ext20AbiInterface;
  ...
  functions: {
    ...
    getBurnerRole(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getBurnerRole(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getBurnerRole(overrides?: CallOverrides): Promise<PopulatedTransaction>;
