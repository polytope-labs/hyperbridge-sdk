...
import type {
  EthereumHostAbi,
  EthereumHostAbiInterface,
  HostParamsStruct,
} from "../EthereumHostAbi";
...
export class EthereumHostAbi__factory {
  static readonly abi = _abi;
  static createInterface(): EthereumHostAbiInterface {
    return new utils.Interface(_abi) as EthereumHostAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EthereumHostAbi {
    return new Contract(address, _abi, signerOrProvider) as EthereumHostAbi;
  }
}
