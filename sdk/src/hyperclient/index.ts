...
import { HyperClient, IConfig } from "@polytope-labs/hyperclient"
import { EVM_CHAINS, HYPERBRIDGE, HYPERBRIDGE_TESTNET, SUBSTRATE_CHAINS } from "./constants"
...
export const getHyperClient = async (sourceChain: string, destChain: string): Promise<HyperClient> => {
